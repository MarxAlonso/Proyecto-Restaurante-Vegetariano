...
| **3) Prueba de Seguridad Web** | [2_seguridad.md#3-reporte-de-pruebas-de-seguridad-web-mitigaciones](file:///c:/developer-marx/Proyectos%20Universitarios/Proyecto%20Restaurante%20Vegetariano/docs/v2/2_seguridad.md#L63-L91) y [3_despliegue.md#5-pruebas-de-calidad-automatizadas-multi-capa-selenium--playwright--supertest](file:///c:/developer-marx/Proyectos%20Universitarios/Proyecto%20Restaurante%20Vegetariano/docs/v2/3_despliegue.md#L125) | **Completo** | Reporte de mitigaciones de XSS y SQLi. ¡Automatizado en la Pirámide de Pruebas: **Supertest** (API) + **Playwright** / **Selenium** (UI)! |
...
| Elemento Requerido | Ubicación en Entregable V2 | Estado | Detalles Técnicos |
| :--- | :--- | :--- | :--- |
| **1) Plan de Pruebas del Sistema** | [3_despliegue.md#1-plan-de-pruebas-del-sistema-qa-plan](file:///c:/developer-marx/Proyectos%20Universitarios/Proyecto%20Restaurante%20Vegetariano/docs/v2/3_despliegue.md#L9-L43) y [3_despliegue.md#5-pruebas-de-calidad-automatizadas-multi-capa-selenium--playwright--supertest](file:///c:/developer-marx/Proyectos%20Universitarios/Proyecto%20Restaurante%20Vegetariano/docs/v2/3_despliegue.md#L125) | **Completo** | Plan enriquecido con una **Pirámide de Pruebas**: **Supertest** (Backend), **Playwright** (E2E Frontend moderno) y **Selenium** (E2E estándar). |
