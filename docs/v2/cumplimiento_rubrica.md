...
| Elemento Requerido | Ubicación en Entregable V2 | Estado | Detalles Técnicos |
| :--- | :--- | :--- | :--- |
| **1) Plan de Pruebas del Sistema** | [3_despliegue.md#1-plan-de-pruebas-del-sistema-qa-plan](file:///c:/developer-marx/Proyectos%20Universitarios/Proyecto%20Restaurante%20Vegetariano/docs/v2/3_despliegue.md#L9-L43) | **Completo** | Plan funcional QA con casos de prueba numerados y detallados (registro, login, platos con subida binaria y cocina). |
